...
CREATE INDEX idx_trades_strategy_time ON trades(strategy_id, signal_time);
CREATE INDEX idx_trades_status ON trades(status);
CREATE INDEX idx_strategies_webhook ON strategies(webhook_token);
...
-- 샘플 데이터
INSERT INTO accounts (account_id, name, account_type, secret_file_path, is_virtual) VALUES
('stock_real', '주식 실전 계좌', 'STOCK', '/config/stock_real.json', false),
('futures_real', '선물 실전 계좌', 'FUTURES', '/config/futures_real.json', false),
('stock_virtual', '주식 모의 계좌', 'STOCK', '/config/stock_virtual.json', true);

INSERT INTO balances (account_id, total_balance, available_balance) VALUES
('stock_real', 10000000, 10000000),
('futures_real', 5000000, 5000000),
('stock_virtual', 10000000, 10000000);

INSERT INTO strategies (name, account_id, webhook_token, max_position_ratio) VALUES
('KOSPI_TREND', 'stock_real', 'webhook_token_1', 0.15),
('FUTURES_MOMENTUM', 'futures_real', 'webhook_token_2', 0.25),
('TEST_STRATEGY', 'stock_virtual', 'webhook_token_3', 0.10);